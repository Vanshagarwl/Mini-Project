...
public class BinarySearchTree {
	...
	public boolean rotateRight(TreeNode root ){
		if (root == null) {
			...
			TreeNode currentNode = root.leftNode;
			root.leftNode=currentNode.rightNode;
			currentNode.rightNode=root;
			root=currentNode;
			return true;
		}
	}
	public TreeNode insertRecursively (TreeNode root,int data){
		...
		if (data<root.data){
			root.leftNode = insertRecursively(root.leftNode,data);
		}
		else{
			root.rightNode = insertRecursively(root.rightNode,data);
